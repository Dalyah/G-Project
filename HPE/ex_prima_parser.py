...
def main():
    ...
    prima_folder="Prima Dataset"
    output="Ready_Data"
    create_csv(input_path="/home/dalyah/GP/Final_Project/HPE/Prima_Dataset", output_path="./output", img_size=64, colour=True, normalisation=False)
    ...
    #create_loo_pickle(csv_path="./output/prima_label.csv", output_path="./output", shuffle=False)
